...
class PlaceImagesControllerTest < ActionController::TestCase
  ...
  test "should create place_image" do
    assert_difference('PlaceImage.count') do
      post :create, place_image: { content_type: @place_image.content_type, data: @place_image.data, place: @place_image.place }
    end
  ...
  test "should update place_image" do
    patch :update, id: @place_image, place_image: { content_type: @place_image.content_type, data: @place_image.data, place: @place_image.place }
    assert_redirected_to place_image_path(assigns(:place_image))
  end
